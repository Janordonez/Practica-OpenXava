 ...
 * Generated at: 2025-11-01 22:50:50 UTC
...
for (int c = 0; it.hasNext(); c++) {
	...
	if (subview.hasCollectionTotal(i, c)) {
      ...
      // /xava/editors/collectionTotals.jsp(53,10) name = name type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      ...
      // /xava/editors/collectionTotals.jsp(53,101) name = name type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      ...
      out.write(">\r\n");
      out.write("	");
      String _jspx_temp0_url = "collectionTotal.jsp";
      String _jspx_temp0_requestEncoding = request.getCharacterEncoding();
      org.apache.jasper.runtime.JspRuntimeLibrary.include(request, response, _jspx_temp0_url + ((_jspx_temp0_url).indexOf('?')>0? '&': '?') + org.apache.jasper.runtime.JspRuntimeLibrary.URLEncode("row", _jspx_temp0_requestEncoding)+ "=" + org.apache.jasper.runtime.JspRuntimeLibrary.URLEncode(String.valueOf(i), _jspx_temp0_requestEncoding) + "&" + org.apache.jasper.runtime.JspRuntimeLibrary.URLEncode("column", _jspx_temp0_requestEncoding)+ "=" + org.apache.jasper.runtime.JspRuntimeLibrary.URLEncode(String.valueOf(c), _jspx_temp0_requestEncoding), out, false);
      out.write("\r\n");
      out.write("	</div>	\r\n");
      out.write("	</td>\r\n");
      out.write("	");
      ...
      out.print((mpListSize>0 && c>=mpListSize) ? "hidden" : "");
      out.write(">\r\n");
      out.write("		<div class=\" ");
      //  xava:id
      ...
      // /xava/editors/collectionTotals.jsp(65,15) name = name type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      ...
      // /xava/editors/collectionTotals.jsp(66,3) name = action type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_xava_005faction_005f0.setAction("CollectionTotals.sumColumn");
      // /xava/editors/collectionTotals.jsp(66,3) name = argv type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
