...
In registroEstudiantil-labels_en.properties:
registroEstudiantil=My application
registroEstudiantil[description]=My application does this and that

In registroEstudiantil-messages_en.properties:
